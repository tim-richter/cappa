...
wraps proven browser automation from Playwright in a workflow tailored for visual reviews so that
...
Continue to the [Quickstart](./quickstart) guide to install the packages and run your first capture
cycle.
