...
- `"pixel"` (default) for pixel-count based comparisons
...
Generated diff PNG files include textual metadata (`tEXt` chunks) with the comparison details. This includes:
