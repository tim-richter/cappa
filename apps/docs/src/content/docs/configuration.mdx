...
- **`retries`** – Control how many attempts Cappa makes before treating a comparison as failed. Read the [Screenshot retries](./screenshot-retries) guide for timing details.
